...
const TextReveal = React.memo(function TextReveal({
  ...
  // Offset is slightly larger than 1em so accented capitals (Í, É, Á…) don't
  // get clipped right at the edge of the reveal window, which made their
  // diacritic peek through and look like a misplaced/wrong accent mark.
  const revealOffset = 1.2;
  const sign = (direction === "up" ? 1 : -1) * revealOffset;
